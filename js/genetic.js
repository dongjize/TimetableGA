    ...
    (function() {
        ...
        var Select1 = {
            ...
            RandomLinearRank: function(pop) {
                this.internalGenState["rlr"] =
                    this.internalGenState["rlr"] || 0;
                return pop[
                    Math.floor(
                        Math.random() *
                            Math.min(pop.length, this.internalGenState["rlr"]++)
                    )
                ].entity;
            },
            Sequential: function(pop) {
                this.internalGenState["seq"] =
                    this.internalGenState["seq"] || 0;
            ...
            this.start = function() {
                ...
                for (i = 0; i < this.configuration.iterations; ++i) {
                    ...
                    if (
                        this.notification &&
                        (isFinished ||
                            this.configuration["skip"] == 0 || i % this.configuration["skip"] == 0)
                    ) {
